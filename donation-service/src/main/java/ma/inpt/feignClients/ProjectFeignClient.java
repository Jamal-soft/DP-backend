...
@FeignClient(/*url = "http://localhost:8081", name = "organisation-service" ,*/   value = "api-gateway")
public interface ProjectFeignClient {
    @PutMapping("/organisation-service/organisations/projects/current-balance/update/{projectId}/{amount}")
